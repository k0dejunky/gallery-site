...
return [
    ...
    ['GET', '/admin/search.json', 'SearchController@suggest'],
    ...
    ['POST', '/admin/galleries/pending/complete', 'GalleryController@chunkComplete'],
    ['POST', '/admin/galleries/pending/abort', 'GalleryController@chunkAbort'],
    ...
    ['POST', '/admin/system/cron-schedule/{job}', 'SystemController@saveCronSchedule'],
